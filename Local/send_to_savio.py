...
if __name__ == "__main__":
    ...
    local_path = "Files/job_shells/Nigeria_Lake_Chad_7.sh"
    shell_remote_dir = "/global/home/users/jeffreyclark/slurm_scripts/"
    remote_path = os.path.join(shell_remote_dir, os.path.basename(local_path))
    s = SavioClient()
    s.upload_files_sftp([local_path], [remote_path])
